...
public class EquationHandler {
    ...
    public LineEquation getLineEquation(Point firstPoint, Point secondPoint) throws Exception {
        ...
        lineEquation.setC(c);
        Log.d(TAG, lineEquation.getEquation());
        return lineEquation;
    }
    ...
    public Point getPointOnLineAtDistance(LineEquation lineEquation, Point pointOnLine,
        ...
        if (polygonPoints.contains(new webonise.mapboxdemo.areabuffer.sromku.Point(firstPoint
    ...
    private Polygon buildPolygon(Point[] polygon) {
        ...
        for (int i = 0; i < polygon.length - 1; i++) {
            ...
            builder.addVertex(
                    new webonise.mapboxdemo.areabuffer.sromku.Point(point.getX(), point.getY()));
        }
